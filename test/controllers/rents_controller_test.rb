...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post rents_url, params: { rent: { data_oddania: @rent.data_oddania, data_wypozyczenia: @rent.data_wypozyczenia, planowana_data_oddania: @rent.planowana_data_oddania } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { data_oddania: @rent.data_oddania, data_wypozyczenia: @rent.data_wypozyczenia, planowana_data_oddania: @rent.planowana_data_oddania } }
