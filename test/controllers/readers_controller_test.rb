...
class ReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reader" do
    assert_difference('Reader.count') do
      post readers_url, params: { reader: { data_urodzenia: @reader.data_urodzenia, email: @reader.email, haslo: @reader.haslo, imie: @reader.imie, nazwisko: @reader.nazwisko, telefon: @reader.telefon } }
    end
  ...
  test "should update reader" do
    patch reader_url(@reader), params: { reader: { data_urodzenia: @reader.data_urodzenia, email: @reader.email, haslo: @reader.haslo, imie: @reader.imie, nazwisko: @reader.nazwisko, telefon: @reader.telefon } }
